...
public:
    ...
    void update_display_for_selection(M5DialDisplay &display) {
        ...
        const int circle_center_y = gfx->height() / 2 + 120; // Shift circle down by 30 pixels
        ...
        gfx->drawString("Navigation mode", circle_center_x, circle_center_y + 130); // Adjust text positions
    }
